...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('tickets', '0026_auto_20190313_1116'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.DateTimeField(default=datetime.datetime(2019, 3, 13, 11, 22, 59, 185640, tzinfo=utc), verbose_name='Время последнего сообщения (часовой пояс UTC)'),
        ),
    ]
