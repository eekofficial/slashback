...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('tickets', '0041_auto_20190314_2105'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.DateTimeField(default=datetime.datetime(2019, 3, 15, 10, 7, 51, 312407, tzinfo=utc), verbose_name='Время последнего сообщения (часовой пояс UTC)'),
        ),
    ]
