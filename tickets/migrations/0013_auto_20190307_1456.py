...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('tickets', '0012_auto_20190307_1423'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.DateTimeField(default=datetime.datetime(2019, 3, 7, 14, 56, 24, 933418, tzinfo=utc), verbose_name='Время последнего сообщения (часовой пояс UTC)'),
        ),
    ]
