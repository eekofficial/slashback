...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('tickets', '0034_auto_20190314_1159'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.DateTimeField(default=datetime.datetime(2019, 3, 14, 12, 1, 31, 609663, tzinfo=utc), verbose_name='Время последнего сообщения (часовой пояс UTC)'),
        ),
    ]
