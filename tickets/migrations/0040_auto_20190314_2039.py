...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('tickets', '0039_auto_20190314_2016'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.DateTimeField(default=datetime.datetime(2019, 3, 14, 20, 39, 33, 745096, tzinfo=utc), verbose_name='Время последнего сообщения (часовой пояс UTC)'),
        ),
    ]
