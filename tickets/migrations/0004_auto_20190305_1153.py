...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('tickets', '0003_auto_20190305_1136'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.DateTimeField(default=datetime.datetime(2019, 3, 5, 11, 53, 30, 300872, tzinfo=utc), verbose_name='Время последнего сообщения (часовой пояс UTC)'),
        ),
    ]
