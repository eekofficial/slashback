...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('tickets', '0032_auto_20190314_1126'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.DateTimeField(default=datetime.datetime(2019, 3, 14, 11, 49, 0, 274945, tzinfo=utc), verbose_name='Время последнего сообщения (часовой пояс UTC)'),
        ),
    ]
