...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('tickets', '0014_auto_20190310_1227'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.DateTimeField(default=datetime.datetime(2019, 3, 10, 13, 10, 22, 116698, tzinfo=utc), verbose_name='Время последнего сообщения (часовой пояс UTC)'),
        ),
    ]
