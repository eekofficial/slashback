# Generated by Django 2.1 on 2019-03-14 21:05
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('cashback_app', '0088_auto_20190314_2039'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='texts',
            name='no_orders',
            field=models.CharField(default='-', max_length=256, verbose_name='Список заказов пуст'),
        ),
        migrations.AddField(
            model_name='texts',
            name='orders_title',
            field=models.CharField(default='-', max_length=256, verbose_name='Заголовок списка заказов'),
        ),
